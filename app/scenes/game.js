...
export default class Game extends Phaser.Scene {
  ...
  preload() {
    //data
    this.ev1data = [
      ["0", "人型の", "蟲型の", "不定形の", "4", "神となった", "\\G人の", "機械の", "太った", "植物の", "影のような", "小さい", "巨女の", "時を止めてくる", "14", "異質の", "古い書物に描かれた", "夜の", "頭が\\G個ある", "ふたなりの", "水中の", "空飛ぶ", "発情した", "ひからびた", "首だけの", "閉じ込められた", "フレンズ化した", "黒く塗りつぶされた", "血まみれの"],
      ["0", "となりの", "ＴＳした", "ゼラチナス", "4", "狂気に飲まれた", "多脚の", "メスガキの", "健康的に日焼けした", "箱化した", "極限まで鍛えた", "デパートの", "奇妙な仮面を付けた", "ひどい匂いのする", "14", "有り金を溶かした", "\\G頭身の", "あお向けに倒れた", "君の", "何かに操られた", "概念となった", "プロ野球選手の", "噛むとほろ苦い", "君を殴った", "脳を交換した", "妹の", "生まれたての", "爆発寸前の", "召喚に応じた"],
      ["0", "音声だけの", "ケイ素生命の", "致命傷を負った", "4", "毛だらけの", "RTAの", "セガ信者の", "サメの", "シュレーディンガーの", "石化した", "最後の生き残りの", "ラビ化した", "外宇宙の", "14", "心の", "\\G英雄の", "野生を取り戻した", "発情期の", "乳房が\\G個ある", "朝\G時", "現場の", "モトラド乗りの", "世界を救った", "配信中の", "電動の", "むちむちの", "壁尻の", "にこにこした"],
      ["0", "ゲーミング", "消えたはずの", "手乗り", "4", "エンペラー", "上質の", "星の", "量産型", "双子の", "フロアを支える", "玉座の", "バイトの", "家元の", "14", "白衣の", "罪を持つ", "先輩の", "ベイッと言う", "重力を操る", "たくさん生えてる", "妊娠した", "殺人", "ＡＩ", "生き別れた", "インテリジェント", "異国の", "いつもの", "木の実の"],
    ];
    this.ev2data = [
    ...
    this.ev3data = [
      ...
      ["0", "君と怪異を合成させて", "波動を感じると闇を睨んで", "アクロバットにユンボを操作して", "4", "自覚がないだけさと君に触れて", "壁をへだてた向こうで", "「よしっ！合体だ」と君に飛びかかり", "恐怖で幼児退行しながら", "イキって死亡フラグを立てながら", "マンションパレードの日に", "\\Cとの戦闘中に", "もう分かんないよと錯乱し", "真の武士道をその武威で体現し", "緊張で汗をだらだら流しながら", "フロアでぺちゃんこ！でも、", "上階からロープを垂らして", "みんなから怒られて、謝罪代わりに", "君を何度も何度も刺しながら", "約束を果たして粒子になりながら", "貴方の子よと赤子を見せて", "幸運にも危険から逃れて", "正しい呪文で扉をひらいて", "\\Cと肩を組んで仲良く", "はっぴーになろうとフロアへ引き込み", "実践はこんなもんじゃないぞと指導し", "禁じられたルールを破り、今こそ", "古代の巨大ロボに乗り込みながら", "わからせ棒をぴたぴたと君に当てて"],
    ];
    this.ev4data = [
      ["0", "挨拶をしてきた。", "襲ってきた。", "帰れと警告してきた。", "4", "君の落とし物を届けてくれた。", "手打ちうどんをごちそうしてくれた。", "ずっと後をつけてくる…", "何かを探していた。", "フロアの物を破壊していた。", "君を殺しに来た。", "\\Cから君を守った。", "君の大切なものを奪った。", "君にキスをした。", "君に決闘を申し込んだ。", "君を閉じ込めた。", "君と\\G年ほど暮らした。", "君に寄生した。", "あたりに火を付けた。", "ベランダから飛び降りた！", "君を無視した。", "君を誘った。", "君を囮にして逃げた。", "壁に消えていった…", "君の服を脱がした。", "君の髪の毛を\\G本毟った！", "君に何かの魔法をかけたようだ…", "君の血を啜った。", "息絶えた…"],
      ["0", "君の金を\\G円奪った。", "君を無理に強化した。", "君をエレベーターに帰した。", "4", "大爆発した。", "ついに負けを認めた。", "勝利を分かち合った。", "君を仲間に加えた。", "信じられないものを出した。", "君のこたつでくつろいだ。", "君を\\Cに売り払った。", "君とエレベーターに乗り込んだ。", "あの情報を教えてくれた。", "毒を散布した。", "作りすぎた肉じゃがをくれた。", "君を罠にはめた。", "君を母にした。", "君を操った。", "君と楽しく飲んだ。", "眠ってしまった…", "\\Cを産み出した。", "壁に大穴を開けた！", "創作物を見せてきた。", "怪異を打ち払った。", "大声で敵を呼び寄せた！", "真の姿になった。", "ある部位から光線を発した。", "もじもじしていた。"],
      ["0", "人体発火した！", "個性を獲得した。", "孤独死した…", "4", "塵となって消えた…", "二度寝した。", "畑の手入れをした。", "\\Cの命を奪った。", "次に遊ぶ日の約束をした。", "灰から復活した！", "脳だけになった。", "君だけの剣になった。", "\\Cの真実を悟った。", "自己紹介をした。", "未来を切り開いた。", "爆撃を開始した。", "死の予言を回避した。", "君を閉所にしまった。", "遭難した。", "青春時代を過ごした。", "仕事の効率を改善した。", "悲しく歌っていた。", "盛大に嘔吐した。", "何もかも諦めた。", "君の無事を祈った。", "記念写真を撮った。", "軍隊での経験を生かした。", "君を\\Gメートル吹き飛ばした。"],
      ["0", "第\\Gのチャクラを開いた。", "うろたえた。", "君と見事な風景を楽しんだ。", "4", "君の身支度を整えた。", "脱皮した。", "\\Cを蹴散らした。", "食事をした。", "探索を開始した。", "君と夜店を回った。", "致命傷を負った。", "大事なデータを消した。", "むちゃくちゃ通販で散財した。", "アヘ顔でぴーすした。", "たからものを見つけた。", "君を救出した。", "NTRした。", "君に謝罪した。", "ボールに戻った。", "必要な書類を出した。", "あるべき状態に変化した。", "フロアの仕掛けを動かした。", "トラップにかかった！", "血を吐いた。", "焚き火でひといきついた。", "ボトルシップを作った。", "君の命令を遂行した。", "君を罰した。"],
    ];
