export default class FloorSelector extends Phaser.Scene {
  ...
  preload() {
    ...
    this.ev2data = [
      ["0", "裸フレンズが", "ケルピーが", "ニセイさんが", "4", "クラウケンが", "異形が", "古狩人が", "ジョンレノが", "宇宙人が", "ボンドルド卿が", "霊体が", "かーさばが", "壁の絵が", "キタキツネが", "警察が", "天使が", "狐ババアが", "ショタが", "ピザ屋が", "狂犬フレンズが", "ワシさんが", "「あけて」君が", "死体が", "７人ミサキが", "光が", "闇が", "悪鬼が", "機械が"],
    ...
    this.ev3data = [
      ["0", "催眠アプリを急に使って", "秘薬をがぶ飲みして", "あどけない幼体に変化して", "4", "よぼよぼの老体に変化して", "暗く君の死を予言して", "廃墟からうかがうようにして", "大草原でうたた寝をしながら", "ぼーっと無反応な様子で", "ご神体に祈りを捧げながら", "１２もの魔法陣を展開して", "燃やせるごみを出しながら", "早口で君を罵倒しながら", "敵の大群を押し留めながら", "いやらしく何かに気づいた様子で", "マンションの清掃をしながら", "音もなく死角に潜んで", "一心不乱に何かを製造しながら", "星々が輝く屋上で", "取引を持ちかけてきて", "尊大な態度で君を挑発して", "岩の上からつまらなさそうにして", "もう間に合わないと君に覆いかぶさり", "まもなく応援が来ると断言して", "疲れた顔でもう何もないと言い", "秘密があるんだと耳打ちして", "怒りで我を忘れて", "決戦への士気を高揚させて"],
    ...
    this.ev4data = [
      ["0", "君の金を奪った。", "君を無理に強化した。", "君をフロアから締め出した。", "4", "大爆発した。", "ついに負けを認めた。", "互いの健闘を祈った。", "君を仲間に加えた。", "信じられないものを出した。", "君のこたつでくつろいだ。", "君を何かに売り払った。", "君とエレベーターに乗り込んだ。", "あの情報を教えてくれた。", "毒を散布した。", "作りすぎた肉じゃがをくれた。", "君を罠にはめた。", "君を母にした。", "君を操った。", "君と楽しく飲んだ。", "眠ってしまった…", "何かを産み出した。", "壁に大穴を開けた！", "創作物を見せてきた。", "怪異を打ち払った。", "大声で敵を呼び寄せた！", "真の姿になった。", "ある部位から光線を発した。", "もじもじしていた。"],
